...
class AdvancedFeatureEngineering:
    ...
    def add_cross_features(df: pd.DataFrame, indicators: Dict) -> pd.DataFrame:
        ...
        result['price_above_upper_bb'] = (bb_position > 0.95).astype(int)  # 價格超過上軌
        ...
        result['stochastic_cross'] = (stoch_k > stoch_d).astype(int)
    ...
    def build_all_features(df: pd.DataFrame, indicators: Dict, 
        ...
        X['stochastic_cross'] = cross_df['stochastic_cross'].fillna(0)
...
if __name__ == '__main__':
    print("此模組應當在 train_models_v2.py 中使用")
